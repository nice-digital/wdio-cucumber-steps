...
describe("waitFor", () => {
	...
	it("should call waitForExist on the browser object", () => {
		...
		expect(global.browser.waitForExist).toHaveBeenCalledWith(
			"element",
			1,
			false
		);
	...
	it("should call waitForSelected on the browser object", () => {
		...
		expect(global.browser.waitForSelected).toHaveBeenCalledWith(
			"element",
			1,
			false
		);
	...
	it("should call waitForEnabled on the browser object", () => {
		...
		expect(global.browser.waitForEnabled).toHaveBeenCalledWith(
			"element",
			1,
			false
		);
	...
	it("should call waitForVisible on the browser object", () => {
		...
		expect(global.browser.waitForVisible).toHaveBeenCalledWith(
			"element",
			1,
			false
		);
	...
	it("should call waitForText on the browser object", () => {
		...
		expect(global.browser.waitForText).toHaveBeenCalledWith(
			"element",
			1,
			false
		);
	...
	it("should call waitForValue on the browser object", () => {
		...
		expect(global.browser.waitForValue).toHaveBeenCalledWith(
			"element",
			1,
			false
		);
